...
public final class SecurePreferences {
    private static final String
            KEY_SHARED_PREFERENCES_NAME = "SecurePreferences",
            KEY_SET_COUNT_POSTFIX = "_count";
     ...
     */
    public static void setValue(@NonNull Context context, @NonNull String key, @NonNull Set<String> value) throws SecureStorageException {
    ...
    public static float getFloatValue(@NonNull Context context, @NonNull String key, float defValue) {
        return Float.parseFloat(Objects.requireNonNull(getStringValue(context, key, String.valueOf(defValue))));
    }
    ...
    public static long getLongValue(@NonNull Context context, @NonNull String key, long defValue) {
        return Long.parseLong(Objects.requireNonNull(getStringValue(context, key, String.valueOf(defValue))));
    }
    ...
    public static int getIntValue(@NonNull Context context, @NonNull String key, int defValue) {
        return Integer.parseInt(Objects.requireNonNull(getStringValue(context, key, String.valueOf(defValue))));
    }
     ...
     */
    @NonNull
    public static Set<String> getStringSetValue(@NonNull Context context, @NonNull String key, @NonNull Set<String> defValue) {
    ...
    public static void clearAllValues(@NonNull Context context) throws SecureStorageException {
        Context applicationContext = context.getApplicationContext();
        if (KeystoreTool.keyPairExists()) KeystoreTool.deleteKeyPair();
    ...
    public static void registerOnSharedPreferenceChangeListener(
            @NonNull Context context, @NonNull SharedPreferences.OnSharedPreferenceChangeListener listener) {
        Context applicationContext = context.getApplicationContext();
        SharedPreferences preferences = applicationContext
                .getSharedPreferences(KEY_SHARED_PREFERENCES_NAME, MODE_PRIVATE);
